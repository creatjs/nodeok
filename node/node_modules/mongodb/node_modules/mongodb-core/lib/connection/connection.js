...
var dataHandler = function(self) {
  return function(data) {
    // Parse until we are done with the mongodata
    while(data.length > 0) {
      ...
      if(self.bytesRead > 0 && self.sizeOfMessage > 0) {
        ...
        if(remainingBytesToRead > data.length) {
          // Copy the new mongodata into the exiting buffer (should have been allocated when we know the message size)
          ...
          // Copy the missing part of the mongodata into our current buffer
        ...
        if(self.stubBuffer != null && self.stubBuffer.length > 0) {
          ...
          if(self.stubBuffer.length + data.length > 4) {
            ...
            // Copy missing part of the mongodata
          ...
          if(data.length > 4) {
            ...
            // var sizeOfMessage = mongodata.readUInt32LE(0);
            ...
            if(sizeOfMessage > 4 && sizeOfMessage < self.maxBsonMessageSize && sizeOfMessage > data.length) {
              ...
              // Copy all the mongodata into the buffer
            ...
            // Copy the mongodata to the stub buffer
