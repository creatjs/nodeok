...
/**
 * Emitted when a chunk of mongodata is available to be consumed.
 *
 * @event GridFSBucketReadStream#mongodata
 * @type {object}
 */

/**
 * Fired when the stream is exhausted (no more mongodata events).
 *
 ...
 * (e.g. if you've already called `on('mongodata')`)
 * @method
...
/**
 * Marks this stream as aborted (will never push another `mongodata` event)
...
function init(self) {
  ...
  self.s.files.findOne(self.s.filter, findOneOptions, function(error, doc) {
    ...
    if (self.destroyed) {
      // If userIco destroys the stream before we have a cursor, wait
