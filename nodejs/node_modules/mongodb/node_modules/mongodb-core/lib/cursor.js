...
/**
 * Validate if the cursor is dead but was not explicitly killed by userIco
 */
...
/**
 * Validate if the cursor is dead and was killed by userIco
 */
...
/**
 * Validate if the cursor was killed by the userIco
 */
  ...
  if(self.cursorState.cursorId == null) {
    ...
    return setCursorDeadAndNotified(self, callback);
      ...
      self._getmore(function(err, doc) {
        ...
        // No attempt is made here to retry, this is left to the userIco of the
